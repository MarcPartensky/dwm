...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_white, col_darkgrey,  col_grey  },
};
...
static const char *spotifynext[] = { ".local/bin/musicctl", "next", NULL };
static const char *spotifyprevious[] = { ".local/bin/musicctl", "previous", NULL };
static const char *spotifytoggle[] = { ".local/bin/musicctl", "play-pause", NULL };
static const char *spotifylike[] = { ".local/bin/spenv", "like", NULL };
static const char *spotifyforward[] = { ".local/bin/spenv", "seek", "+10", NULL };
static const char *spotifybackward[] = { ".local/bin/spenv", "seek", "-10", NULL };
...
static Key keys[] = {
	...
	{ Mod1Mask|ShiftMask,           XK_d,      spawn,          {.v = spotifyforward } },
	{ Mod1Mask|ShiftMask,           XK_s,      spawn,          {.v = spotifybackward } },
