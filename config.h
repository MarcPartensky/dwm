...
static const char *fonts[]          = { "UbuntuMono Nerd Font:pixelsize=15:antialias=true:autohint=true" };
static const char dmenufont[]       = "UbuntuMono Nerd Font:pixelsize=15:antialias=true:autohint=true";
...
static const char *spotifytoggle[] = { "playerctl", "-p", "spotifyd", "play-pause", NULL };
static const char *spotifylike[] = { ".local/bin/spenv", "splike", NULL };
